...
void validar_estados(){
    ...
    PORTAbits.RA0=PORTAbits.RA3=PORTEbits.RE0 = 1;
    ...
    switch(estados){
        ...
        case 5:
            PORTAbits.RA3=1; PORTAbits.RA4=0; PORTAbits.RA5=0;
            time2 = t_ra;
            break;

        case 6: if(time2==0){
                   time2=t_v;
                   PORTAbits.RA3=1; PORTAbits.RA4=1; PORTAbits.RA5=0;
                }
                else{
                    PORTAbits.RA3=1; PORTAbits.RA4=1; PORTAbits.RA5=0;
                    estados--;
        ...
        case 7: if(time2==0){
                   time2=t_a;
                   PORTAbits.RA3=0; PORTAbits.RA4=0; PORTAbits.RA5=1;
                }
                else{
                    PORTAbits.RA3=0; PORTAbits.RA4=0; PORTAbits.RA5=1;
                    estados--;
                ...
                break;
        case 8: if(time2!=0){
                    PORTAbits.RA3=0; PORTAbits.RA4=1; PORTAbits.RA5=0;
                    estados--;
                    time2--;
                }
                else{
                ...
                break;
        case 9: PORTAbits.RA3=1; PORTAbits.RA4=0; PORTAbits.RA5=0; break;





        case 10: PORTEbits.RE0=1; PORTEbits.RE1=0; PORTEbits.RE2=0;
                time3 = t_ra;
                break;
        case 11: if(time3==0){
                   time3=t_v;
                   PORTEbits.RE0=1; PORTEbits.RE1=1; PORTEbits.RE2=0;
                }
                else{
                    PORTEbits.RE0=1; PORTEbits.RE1=1; PORTEbits.RE2=0;
                    estados--;
...
void seven(int numero, int posicion){
    ...
    PORTC = deco[numero];
    PORTD = pos[posicion];
    _delay((unsigned long)((1)*(4000000L/4000.0)));
    PORTD = 0;
}

void __attribute__((picinterrupt(("")))) tmr0(){
...
void main(void) {
    ...
    PORTAbits.RA0=PORTAbits.RA3=PORTEbits.RE0 = 1;
    PORTAbits.RA1=PORTAbits.RA4=PORTEbits.RE1 = 0;
    PORTAbits.RA2=PORTAbits.RA5=PORTEbits.RE2 = 0;
